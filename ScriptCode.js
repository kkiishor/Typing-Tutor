...
function medium() 
{
   ...
   "Kishor, Tejas, Shivraj and Pranit are the head of decoration committee.")
   word = 10
}
function large() 
{
...
function small()
{
   msg = new Array("Kishor, Tejas, Shivraj and Pranit are group members .",
   "Who teaches javascript to us?",
   "Jyoti mam teaches javascript.",
   "Shivraj Sakunde is president of IT department.")
   word = 7
}
function beginIt() 
{
